...
<body>
    ...
    <nav>
        <div class="nav-left">
            <img src="<?php echo e(asset('img/Gambar_SMKN_1SUBANG.png')); ?>" alt="Logo" class="nav-logo">
    ...
    <div class="login-wrap">
        <div class="card">
            ...
            <form action="/login" method="POST">
                ...
                <input id="username" type="text" name="username" value="<?php echo e(old('username')); ?>" placeholder="Masukkan username" required>
...
<?php /**PATH D:\PROJECT\LARAVEL\BUDI\resources\views/admin/admin-login.blade.php ENDPATH**/ ?>